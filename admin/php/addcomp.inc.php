<?php 
	...
	if (isset($_POST['add'])) {
		...
		$sql1 = "INSERT INTO `company` (`id`, `name`, `type`, `address`, `number`, `website`, `status`,`minperc`,`package`) VALUES (NULL, '$cname', '$ctype', '$address', '$phone', '$website', '$status','$minperc','$cpkg');";
	...
	if (isset($_POST['update'])) {
		...
		$sql = "update company set name='$cname', website='$website', address='$address', type='$ctype', status='$status', number='$phone', minperc='$minperc' , package='$cpkg' where id='$cid';";
