		    ...
		    <div class="row justify-content-center align-items-baseline">
		      <div class="center one">
		        <div class="form-row">
					...
					<div class="form-group col-md-6">
			          <label for="minperc">Minimum Percentage Required</label>
			          <input type="number" class="form-control" id="minperc" name="minperc" placeholder="Minimum Percentage Required" required>
			        </div>
		        ...
		        <div class="form-row">
					...
					<div class="form-group col-md-6">
			          <label for="cpkg">Package</label>
			          <input type="number" class="form-control" id="cpkg" name="cpkg" placeholder="package in LPA" required>
			        </div>
