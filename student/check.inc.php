    ...
    if (isset($_POST['check'])) {
        ...
        if (mysqli_num_rows($res) > 0) {
			...
			font-weight: bold; background: linear-gradient(to left, #F55197, #EE891A);" name="apply">Apply</a>
                            ...
                            ?>  
                                <h5>Your Criteria for <b><?php echo $company; ?></b><br> doesn't match expectations</h5> <br>
                                <p class="lead">Chances of getting placed</p>
                                    <div class="progress" style="position:absolute; width: 500px;">
                                        <div class="progress-bar bg-danger" role="progressbar" style="width: 0%;" aria-valuenow="0" 
                                        aria-valuemin="0" aria-valuemax="100" name="chances">0%</div>
                                    </div> <br> <br>
                                    <p class="lead">You are not eligible to apply for this company. <br> The company's package should be 1.5 times higher than your previous acquired package</p>
                                    <p class="medium text-danger"><i class="fas fa-exclamation-circle"></i> Make sure you have updated your percentage 
                                    in <b><u><a href="editprofile.php" class="text-danger">Edit Profile</a></u></b> section!</p>
